...
function loadPokemon(nametag) {
		...
		el.querySelectorAll('.final_hp')[0].textContent = pkmn.final_hp;
		el.querySelectorAll('.final_att')[0].textContent = pkmn.final_att;
		el.querySelectorAll('.final_def')[0].textContent = pkmn.final_def;
		el.querySelectorAll('.final_spa')[0].textContent = pkmn.final_spa;
		el.querySelectorAll('.final_spd')[0].textContent = pkmn.final_spd;
		el.querySelectorAll('.final_vel')[0].textContent = pkmn.final_vel;
